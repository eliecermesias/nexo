<x-layouts::app.sesion :title="__('Register')">
    <div class="flex flex-col gap-6">
        <h1 class="text-3xl font-bold text-white text-center mb-3">{{ __('Create an account') }}</h1>
        <p class="text-slate-400 text-center text-sm mb-10">{{ __('Enter your details below to create your account') }}</p>
        ...
        <form method="POST" action="{{ route('register.store') }}" class="flex flex-col gap-6">
            ...
            <!-- Name -->
            <div class="space-y-2">
                <label for="name" class="block text-sm font-medium text-slate-400">{{ __('Name') }}</label>
                <div class="relative">
                        <input type="text" id="name" name="name"
                        class="block w-full bg-slate-800 border border-slate-700 rounded-lg p-4 text-slate-200 placeholder-slate-500 focus:ring-2
                        focus:ring-blue-500 focus:border-blue-500 transition" placeholder="Name" :label="__('Name')"
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                        ...
                        class="block w-full bg-slate-800 border border-slate-700 rounded-lg p-4 text-slate-200 placeholder-slate-500 focus:ring-2
                        focus:ring-blue-500 focus:border-blue-500 transition" placeholder="email@example.com" :label="__('Email address')"
